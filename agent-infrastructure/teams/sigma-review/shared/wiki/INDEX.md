...
- [Enterprise AI Rollout — Financial Services](enterprise-ai-rollout-finserv.md) — four conditions model, SR 11-7 compliance architecture, compliance x adoption heuristic, ROI calibration (P=0.35 18mo), survivorship bias, cognitive biases in vendor selection, timeline base rates, pre-mortem taxonomy, measurement debiasing [R18, 26.4.16]; FS AI RMF Feb 2026, FINRA RN 25-07 + 2026 AROR, NAIC 12-state pilot, NYDFS Oct 2025 TPSP letter, capability-to-examiner crosswalk, SR 11-7 examiner-vocabulary translation, trust-company graduated lethal-trifecta, CoT not audit-trail, EU gateway residency, unbudgeted cost categories [R-2026-04-22-ai-agent-rollout-playbook-vet, 26.4.28]
- [Enterprise AI Rollout — B2B SaaS](enterprise-ai-rollout-b2b-saas.md) — phased workbook as primary execution scaffold, multi-tenancy ANN pre-filter gap, EU AI Act Annex III para 2 employment monitoring, Art 25(1)(b) fine-tuning hook, CCPA ADMT operationalization, GDPR Art 22 worker-as-data-subject, SOC 2 TSC-to-AI-control mapping, vendor-platform-first as legitimate architecture [R-2026-04-22-ai-agent-rollout-playbook-vet, 26.4.28]
- [AI Agent Reference Architecture — 2026](ai-agent-reference-architecture-2026.md) — gateway, OBO/SPIFFE, OTel GenAI v1.37, vector store thresholds (pgvector/Qdrant/Turbopuffer), MCP security posture + 5-criterion allowlist rubric, guardrails data-sovereignty distinction, CaMeL per-tool codification, eval platform differentiation (Langfuse, Inspect AI), Cloudflare Sandboxed Workers, Statsig concentration risk, EU gateway residency, vendor switchover runbook [R-2026-04-22-ai-agent-rollout-playbook-vet, 26.4.28]
- [AI Agent Governance Committee Design](ai-agent-governance-committee-design.md) — committee structure, 4 design gaps (pre-commitment, independent challenger, pre-mortem, chair-decides), specification-level tier gates, 5 tier-promotion biases + structural interventions, reviewer calibration at production scale, criteria drift revision process, over-reliance behavioral detection, firm-size floor (~$500M / ~30 person tech org) [R-2026-04-22-ai-agent-rollout-playbook-vet, 26.4.28]
- [Multi-Agent Systems Security](multi-agent-systems-security.md) — agent-to-agent trust boundaries, MITRE ATLAS AML.T0051, composite lethal trifecta, A2A protocol, GDPR Art 26 joint-controller doctrine, LangGraph default credential inheritance, long-term agent memory open questions [R-2026-04-22-ai-agent-rollout-playbook-vet, 26.4.28]
