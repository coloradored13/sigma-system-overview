...
- [AI PD Tracker](project_ai-pd-tracker.md) — ~/Projects/ai-pd-tracker/ FastAPI+SQLite curriculum tracker, 10 steps shipped 26.4.20 + verified source ledger (23/23) + curriculum schema (track/gate/notebook_id) + 6 NotebookLM manifests + DEFERRED.md 26.4.29-30 + Track B 8/8 Operator Foundations shipped 26.5.7 commit 08a5426 (41.5h, capstone=Field Guide self-application = velvety-swinging-coral Stream 3 closed) + Field Guide v2 citation-inserted (10 insertions, all PASS-verified) shipped 26.5.7 commit d458f22 (voice-polish pending = Stream 4). Private repo coloradored13/ai-pd-tracker, coach validated (shares sigma-verify API key)
