...
- [AI PD Tracker](project_ai-pd-tracker.md) — ~/Projects/ai-pd-tracker/ FastAPI+SQLite curriculum tracker, 10 steps shipped 26.4.20 + Field Guide work area + verified source ledger (23/23) + curriculum schema (track/gate/notebook_id) + 6 NotebookLM manifests + DEFERRED.md 26.4.29-30 + Track B 8/8 Operator Foundations shipped 26.5.7 commit 08a5426 (41.5h, capstone=Field Guide self-application = velvety-swinging-coral Stream 3 closed). Private repo coloradored13/ai-pd-tracker, coach validated (shares sigma-verify API key)
