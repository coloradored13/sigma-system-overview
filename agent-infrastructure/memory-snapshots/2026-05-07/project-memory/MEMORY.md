...
- [Cutebot MCP](project_cutebot-mcp.md) — ~/Projects/cutebot-mcp/ MCP server driving ELECFREAKS Cutebot via 2 µbits + radio, hateoas-agent discover mode, channel=7/group=42, 500ms watchdog, v0.1 step 5/6 complete drive untested 26.5.2
