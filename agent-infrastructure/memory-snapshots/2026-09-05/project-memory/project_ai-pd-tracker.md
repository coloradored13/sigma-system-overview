...
**Next.** Wave 3 (review-retrieval gate; coach-only path via the assessor) before the first review falls due → P2/P3 currency proposals await the user's approval → slot-1 cold case authored the day before the Sprint readiness gate → learner starts Day 1.
